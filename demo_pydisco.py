...
if __name__ == "__main__":
  ...
  for i in range(n_imgs):
    ...
    # pydsico stuff
    xyz_camX = pydisco_utils.depth2pointcloud(torch.tensor(depth_im).unsqueeze(0).unsqueeze(0), pix_T_camX)
    origin_T_camX = torch.tensor(cam_pose).unsqueeze(0)
    xyz_camOrigin = pydisco_utils.apply_4x4(origin_T_camX, xyz_camX)
